...
#2. 데이터 준비 (6월 커리큘럼: 데이터 가공 단계에서 학생들이 채울 부분)
# 실제로는 CSV나 GPX 파일을 불러오겠지만, 테스트용으로 데이터를 직접 넣었습니다.
courses = {
    "A코스 (초급)": {"lat": 37.5665, "lon": 126.9780, "color": "blue", "desc": "경사가 완만하여 초보자에게 추천합니다."},
    "B코스 (중급)": {"lat": 37.5700, "lon": 126.9830, "color": "red", "desc": "계단이 많지만 경치가 매우 좋습니다."}
}
